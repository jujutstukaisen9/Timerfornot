...
channel_username = "@not_pixel_alaram"  # Change this to your channel's username
...
async def test_message(client, message):
    try:
        await app.send_message(channel_username, "Test message to channel.")
        await message.reply("Test message sent successfully!")
    except PeerIdInvalid:
        await message.reply(f"Error: The channel username {channel_username} is invalid or the bot has not been added to the channel.")
...
async def send_alarm_message():
    try:
        await app.send_message(channel_username, "⏰ This is a scheduled alarm message!")
    except PeerIdInvalid:
        print(f"Error: The channel username {channel_username} is invalid or the bot has not been added to the channel.")
    except Exception as e:
